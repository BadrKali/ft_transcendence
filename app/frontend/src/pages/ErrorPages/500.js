        ...
        <div className={styles.container}>
          ...
          <div className={styles.right}>
            <div className={styles.textContainer}>
              ...
              <div className={styles.status}>Internal Server Error</div>
              <div className={styles.description}>
                Pongy failed to process your request, you probably tested something that you shouldn't have?
              </div>
              <div className={styles.buttonContainer}>
                <a href="/" className={styles.button}>Back to home</a>
              </div>
              <div className={styles.footer}>
                The corrector is crying in the corner.
              </div>
            </div>
          </div>
        </div>
