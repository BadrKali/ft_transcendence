...
class GameSettings(models.Model):
    ...
    background = models.CharField(max_length=255, default="hell")
    paddle = models.CharField(max_length=255, default="#BC4F00")
    keys = models.CharField(max_length=255, default="up-down")
