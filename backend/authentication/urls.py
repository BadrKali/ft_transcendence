...
from .views import UserRegistration,CurrentUserView, UserView, CustomTokenObtainPairView, CustomTokenRefreshView, CallbackView, TwoFactorAuthView
...
urlpatterns = [
    ...
    path("2fa/", TwoFactorAuthView.as_view(), name="auth_callback"),
]